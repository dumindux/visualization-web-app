...
!function (a, b) {
    ...
    function e(a, c, d) {
        var e, f;
        if (a)if (a.forEach)a.forEach(c, d); else if (a.length !== b)for (e = 0, f = a.length; f > e; e++)c.call(d, a[e], e, a); else for (e in a)a.hasOwnProperty(e) && c.call(d, a[e], e, a)
    }
    ...
    function x(a, b, c) {
        var d = c.pointers.length, e = c.changedPointers.length, f = b & tb && d - e === 0, g = b & (vb | wb) && d - e === 0;
    ...
    function y(a, b) {
        ...
        var f = c.firstInput, g = c.firstMultiple, h = g ? g.center : f.center, i = B(d);
    ...
    function z(a, c) {
        ...
        if (i > sb || d.velocity === b) {
            var j = d.deltaX - c.deltaX, k = d.deltaY - c.deltaY, l = C(i, j, k);
    ...
    function A(a) {
        ...
        return {timeStamp: ib(), pointers: b, center: B(b), deltaX: a.deltaX, deltaY: a.deltaY}
    }

    function B(a) {
        var b = a.length;
        if (1 === b)return {x: gb(a[0].clientX), y: gb(a[0].clientY)};
        for (var c = 0, d = 0, e = 0; b > e; e++)c += a[e].clientX, d += a[e].clientY;
        return {x: gb(c / b), y: gb(d / b)}
    }
    ...
    function L(a, b) {
        var c, d, e = b.targetIds, f = r(a.targetTouches), g = r(a.changedTouches), h = [];
    ...
    function ab(a, b) {
        var c = a.element, d = a.options.cssProps;
        e(d, function (a, d) {
    ...
    var cb = ["", "webkit", "moz", "MS", "ms", "o"], db = document.createElement("div"), eb = "function", fb = "undefined", gb = Math.round, hb = Math.abs, ib = Date.now, jb = 1, kb = /mobile|tablet|ip(ad|hone|od)|android/i, lb = "ontouchstart" in a, mb = t(a, "PointerEvent") !== b, nb = lb && kb.test(navigator.userAgent), ob = "touch", pb = "pen", qb = "mouse", rb = "kinect", sb = 25, tb = 1, ub = 2, vb = 4, wb = 8, xb = 1, yb = 2, zb = 4, Ab = 8, Bb = 16, Cb = yb | zb, Db = Ab | Bb, Eb = Cb | Db, Fb = ["x", "y"], Gb = ["clientX", "clientY"];
    v.prototype = {
        handler: function () {
        }, destroy: function () {
    ...
    var Hb = {
        ...
        mouseup: vb,
        mouseout: wb
    }, Ib = "mousedown", Jb = "mousemove mouseout mouseup";
    h(I, v, {
        handler: function (a) {
            var b = Hb[a.type];
    ...
    var Kb = {pointerdown: tb, pointermove: ub, pointerup: vb, pointercancel: wb, pointerout: wb}, Lb = {
        2: ob,
        3: pb,
        4: qb,
        5: rb
    }, Mb = "pointerdown", Nb = "pointermove pointerout pointerup pointercancel";
    a.MSPointerEvent && (Mb = "MSPointerDown", Nb = "MSPointerMove MSPointerOut MSPointerUp MSPointerCancel"), h(J, v, {
        handler: function (a) {
            var b = this.store, c = !1, d = a.type.toLowerCase().replace("ms", ""), e = Kb[d], f = Lb[a.pointerType] || a.pointerType, g = a.relatedTarget || a.toElement || a.target;
    ...
    h(K, v, {
        ...
        handler: function (a, b, c) {
            var d = c.pointerType == ob, e = c.pointerType == qb;
    ...
    var Qb = t(db.style, "touchAction"), Rb = Qb !== b, Sb = "compute", Tb = "auto", Ub = "manipulation", Vb = "none", Wb = "pan-x", Xb = "pan-y";
    N.prototype = {
        set: function (a) {
            ...
            if (!Rb) {
                ...
                var d = this.actions, e = o(d, Vb), f = o(d, Xb), g = o(d, Wb);
    ...
    var Yb = 1, Zb = 2, $b = 4, _b = 8, ac = _b, bc = 16, cc = 32;
    P.prototype = {
        ...
        defaults: {pointers: 1}, attrTest: function (a) {
            ...
            var b = this.state, c = a.eventType, d = b & (Zb | $b), e = this.attrTest(a);
            return d && (c & wb || !e) ? b | bc : d || e ? c & vb ? b | _b : b & Zb ? b | $b : Zb : cc
        }
    }), h(U, T, {
        defaults: {event: "pan", threshold: 10, pointers: 1, direction: Eb}, getTouchAction: function () {
        ...
        defaults: {event: "press", pointers: 1, time: 500, threshold: 5}, getTouchAction: function () {
            ...
            var b = this.options, d = a.pointers.length === b.pointers, e = a.distance < b.threshold, f = a.deltaTime > b.time;
            if (this._input = a, !e || !d || a.eventType & (vb | wb) && !f)this.reset(); else if (a.eventType & tb)this.reset(), this._timer = c(function () {
                this.state = ac, this.tryEmit()
            }, b.time, this); else if (a.eventType & vb)return ac;
            return cc
        }, reset: function () {
        ...
        defaults: {
            ...
            if (e && f && d) {
                ...
                var g = this.pTime ? a.timeStamp - this.pTime < b.interval : !0, h = !this.pCenter || E(this.pCenter, a.center) < b.posThreshold;
        ...
        touchAction: Sb,
        enable: !0,
        preset: [[X, {enable: !1}], [V, {enable: !1}, ["rotate"]], [Y, {direction: Cb}], [U, {direction: Cb}, ["swipe"]], [Z], [Z, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [W]],
        cssProps: {
    ...
    _.prototype = {
        set: function (a) {
            ...
            if (!this.session.stopped) {
                ...
                var b, c = this.session, d = c.curRecognizer;
